...
// Page counts use fractional values from the standard Madani Mushaf
// so short surahs in Juz 30 are represented accurately.
// ═══════════════════════════════════════════════════════════════
...
export interface SuraMetadata {
  ...
  totalPages: number;   // Fractional page count (e.g. 0.5, 0.25)
 ...
 * Long suras keep integer values; short suras in Juz 30 use fractional
 * values that sum to their real shared pages.
 */
export const SURA_METADATA: SuraMetadata[] = [
  ...
  // ─── Juz 30 — accurate fractional page counts ───
  { number: 78,  nameAr: 'النبأ',        startPage: 582, endPage: 583, totalPages: 2,    juzStart: 30 },
  { number: 79,  nameAr: 'النازعات',     startPage: 583, endPage: 584, totalPages: 1.5,  juzStart: 30 },
  ...
  { number: 82,  nameAr: 'الانفطار',     startPage: 587, endPage: 587, totalPages: 0.5,  juzStart: 30 },
  { number: 83,  nameAr: 'المطففين',     startPage: 587, endPage: 589, totalPages: 2,    juzStart: 30 },
  { number: 84,  nameAr: 'الانشقاق',     startPage: 589, endPage: 589, totalPages: 0.75, juzStart: 30 },
  { number: 85,  nameAr: 'البروج',       startPage: 590, endPage: 590, totalPages: 0.75, juzStart: 30 },
  { number: 86,  nameAr: 'الطارق',       startPage: 591, endPage: 591, totalPages: 0.5,  juzStart: 30 },
  { number: 87,  nameAr: 'الأعلى',       startPage: 591, endPage: 592, totalPages: 0.5,  juzStart: 30 },
  { number: 88,  nameAr: 'الغاشية',      startPage: 592, endPage: 592, totalPages: 0.75, juzStart: 30 },
  { number: 89,  nameAr: 'الفجر',        startPage: 593, endPage: 594, totalPages: 1.5,  juzStart: 30 },
  { number: 90,  nameAr: 'البلد',        startPage: 594, endPage: 594, totalPages: 0.75, juzStart: 30 },
  { number: 91,  nameAr: 'الشمس',        startPage: 595, endPage: 595, totalPages: 0.5,  juzStart: 30 },
  { number: 92,  nameAr: 'الليل',        startPage: 595, endPage: 596, totalPages: 0.75, juzStart: 30 },
  { number: 93,  nameAr: 'الضحى',        startPage: 596, endPage: 596, totalPages: 0.25, juzStart: 30 },
  { number: 94,  nameAr: 'الشرح',        startPage: 596, endPage: 596, totalPages: 0.25, juzStart: 30 },
  { number: 95,  nameAr: 'التين',        startPage: 597, endPage: 597, totalPages: 0.5,  juzStart: 30 },
  { number: 96,  nameAr: 'العلق',        startPage: 597, endPage: 597, totalPages: 0.5,  juzStart: 30 },
  { number: 97,  nameAr: 'القدر',        startPage: 598, endPage: 598, totalPages: 0.5,  juzStart: 30 },
  { number: 98,  nameAr: 'البينة',       startPage: 598, endPage: 599, totalPages: 1,    juzStart: 30 },
  { number: 99,  nameAr: 'الزلزلة',      startPage: 599, endPage: 599, totalPages: 0.5,  juzStart: 30 },
  { number: 100, nameAr: 'العاديات',     startPage: 599, endPage: 600, totalPages: 0.5,  juzStart: 30 },
  { number: 101, nameAr: 'القارعة',      startPage: 600, endPage: 600, totalPages: 0.5,  juzStart: 30 },
  { number: 102, nameAr: 'التكاثر',      startPage: 600, endPage: 600, totalPages: 0.5,  juzStart: 30 },
  { number: 103, nameAr: 'العصر',        startPage: 601, endPage: 601, totalPages: 0.25, juzStart: 30 },
  { number: 104, nameAr: 'الهمزة',       startPage: 601, endPage: 601, totalPages: 0.5,  juzStart: 30 },
  { number: 105, nameAr: 'الفيل',        startPage: 601, endPage: 601, totalPages: 0.25, juzStart: 30 },
  { number: 106, nameAr: 'قريش',         startPage: 602, endPage: 602, totalPages: 0.25, juzStart: 30 },
  { number: 107, nameAr: 'الماعون',      startPage: 602, endPage: 602, totalPages: 0.5,  juzStart: 30 },
  { number: 108, nameAr: 'الكوثر',       startPage: 602, endPage: 602, totalPages: 0.25, juzStart: 30 },
  { number: 109, nameAr: 'الكافرون',     startPage: 603, endPage: 603, totalPages: 0.5,  juzStart: 30 },
  { number: 110, nameAr: 'النصر',        startPage: 603, endPage: 603, totalPages: 0.25, juzStart: 30 },
  { number: 111, nameAr: 'المسد',        startPage: 603, endPage: 603, totalPages: 0.25, juzStart: 30 },
  { number: 112, nameAr: 'الإخلاص',      startPage: 604, endPage: 604, totalPages: 0.25, juzStart: 30 },
  { number: 113, nameAr: 'الفلق',        startPage: 604, endPage: 604, totalPages: 0.25, juzStart: 30 },
  { number: 114, nameAr: 'الناس',        startPage: 604, endPage: 604, totalPages: 0.5,  juzStart: 30 },
];

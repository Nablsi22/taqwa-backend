...
export class PointsService {
  ...
  /**
   * Award points to a student manually (instructor / admin action).
   * Stamped with sourceType = 'MANUAL' so it can be distinguished
   * from auto-awarded points (RECITATION, ATTENDANCE).
   */
  ...
  /**
   * Delete a points log entry directly (admin only).
   * Note: this only deletes the points row itself. If the points were
   * generated by a recitation or attendance, the source activity is
   * untouched — that's intentional. Use deleteRecitation / deleteAttendance
   * if you want the cascading delete in the other direction.
   */

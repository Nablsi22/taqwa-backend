...
const PTS = { GOOD: 1, VERY_GOOD: 2, MAQRAA: 0 };
function pts(rating, pages) {
    if (pages <= 0)
        return 0;
    if (rating === 'MAQRAA')
        return 0;
...
function precise(s) {
    const m = (0, quran_ayat_pages_util_1.getSurahMeta)(s);
    return m ? (0, quran_ayat_pages_util_1.calculatePages)(s, 1, s, m.numAyas) : 0;
}
async function main() {
...
//# sourceMappingURL=fullsura-impact.js.map